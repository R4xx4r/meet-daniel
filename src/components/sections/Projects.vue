  ...
  <section class="block block--projects projects" id="projects">
    <SectionObserver>
      <div class="content-wrapper">
          ...
          <div class="projects__filters filters">
            <div class="filters__dropdown-wrapper" v-cloak>
              <select
                ...
                @change="setActiveIndex($event.target.value)"
        ...
        <button
          class="projects__button projects__button--more"
...
export default {
          ...
          projects: [
            ...
            },
            {
              ...
              modal: {
                ...
                description:
                  'Als Webdev der <a href="https://mmcagentur.at/" target="_blank">MMCAGENTUR</a> haben wir diese Nuxt.js Kampagnenseite umgesetzt. Die fertig gebuildete Seite wurde als Proxyframe in der Mutterseite eingebunden.',
            ...
            },
            {
              ...
              modal: {
                intro: "Kampagnen Seite",
                description:
                  'Als Webdev der <a href="https://mmcagentur.at/" target="_blank">MMCAGENTUR</a> haben wir diese Nuxt.js Kampagnenseite umgesetzt. Die fertig gebuildete Seite wurde als Proxyframe in der Mutterseite eingebunden. Besonderheit ist ein Gewinnspiel bei welchem man per Drag & Drop Elemente richtig platzieren muss.',
          ...
          projects: [
            {
              ...
              modal: {
                intro: "Website Relaunch",
                description:
                  'Als eines meiner ersten Projekte habe ich der alten Yoga Neufeld einen neuen Anstrich verpasst. Hierzu habe ich ein fertiges Template von <a href="http://html5up.net" target="_blank">HTML5up</a> als Basis hergenommen, modifiziert und um neue "Module" erweitert.',
            ...
            },
            {
              ...
              modal: {
                intro: "Website Relaunch",
                description:
                  'Als Webdev der <a href="https://mmcagentur.at/" target="_blank">MMCAGENTUR</a> war ich Teil der kompletten Umsetzung dieser Seite. Umgesetzt wurde das Projekt mit einem intern entwickelten System welches auf Webpack, Handlebars und HTML, SCSS und JS basiert.',
          ...
          projects: [
            {
              ...
              image: "projects/medani/medani_01.jpg",
              modal: {
                intro: "Website Relaunch",
                description:
                  'Mein erstes Projekt als Webdev der <a href="https://www.medani.at/" target="_blank">medani gmbh</a>. Als Team haben wir der Firmeneigenen Seite einen Neuanstrich verpasst. Ich habe bei der Finalisierung der Seite einige Frontend Issues übernommen und einige Teile im Backend gerefactored.',
                href: "https://www.medani.at/",
                images: [
                  "projects/medani/medani_01.jpg",
                  "projects/medani/medani_03.jpg",
                  "projects/medani/medani_02.jpg",
                ],
              },
            },
            {
              ...
              modal: {
                intro: "Website Relaunch",
                description:
                  'Als Webdev der <a href="https://mmcagentur.at/" target="_blank">MMCAGENTUR</a> war ich hier in erster Linie als Frontender tätig, habe aber aucher alle Backend Tätigkeiten vorgenommen. Die einzelnen Module der Seite basieren auf dem WP-Plugin "Advanced Custom Fields".',
            ...
            },
            {
              ...
              modal: {
                intro: "Website Relaunch",
                description:
                  'Als Webdev der <a href="https://mmcagentur.at/" target="_blank">MMCAGENTUR</a> war ich hier als Backend Dev tätig. Dieses Projekt war eines meiner ersten Berührungspunkte mit dem Wordpress Backend. Die Module basieren auf dem WP-Plugin "Advanced Custom Fields".',
          ...
          projects: [
            {
              ...
              image:
                "projects/Ottakringer_Helles_ohne_Flasche_Kanne_Logo_PRINT.jpg",
              modal: {
                intro: "Website Relaunch",
                description:
                  'Als Webdev der <a href="https://mmcagentur.at/" target="_blank">MMCAGENTUR</a> war ich hier als Backend Dev tätig. Dieses Projekt wurde agil umgesetzt und war in enger Zusammenarbeit aller beteiligter Teams eine großartige Erfahrung.',
            ...
            },
            {
              ...
              modal: {
                intro: "Website Relaunch",
                description:
                  'Als Webdev der <a href="https://mmcagentur.at/" target="_blank">MMCAGENTUR</a> war ich hier als Backend Dev tätig. Teil meiner Umsetzung war die Planung und Überlegung der einzelnen Content Elemente und wie man diese sinnvoll und intuitiv zur Verfügung stellen kann.',
            ...
            },
            {
              ...
              modal: {
                intro: "Website Relaunch",
                description:
                  'Als Webdev der <a href="https://mmcagentur.at/" target="_blank">MMCAGENTUR</a> war ich hier als Backend Dev tätig. Hier hatten wir die Herausforderung mehrere Schnittstellen zu integrieren um eine enorme Menge an sensiblen Daten schnell und strukturiert darzustellen.',
  ...
  computed: {
    visibleProjects() {
      return this.categoriesWithProjects[this.selectedIndex]["projects"].slice(
        0,
        this.page * this.projectsPerPage
      );
    },
    maxPages() {
      return (
        this.categoriesWithProjects[this.selectedIndex]["projects"].length /
...
.animate .projects__headline::after {
  animation: left-to-right 1s 0.5s ease-in-out forwards;
}
